...
public class OrderPojo implements Serializable {
	...
	public void setFieldsByAnotherOrder(OrderPojo order) {
	...
	public OrderPojo(int id, int quantity, Date ordering_day,
			by.academy.alekhno.database.pojo.UserPojo user, ClotherPojo clother,
			StatePojo state) {
		this.id = id;
